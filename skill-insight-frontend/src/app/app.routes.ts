...
// import { SetPasswordComponent } from './pages/dashboard/profile/set-password/set-password';
...
//         path: 'profile',
//         loadComponent: () =>
//           import('./pages/dashboard/profile/profile/profile').then(m => m.ProfileComponent)
//       },
//       {
//         path: 'change-password',
//         loadComponent: () =>
//           import('./pages/dashboard/profile/change-password/change-password').then(m => m.ChangePasswordComponent)
//       },
//       {
//         path: 'set-password',
//         loadComponent: () =>
//           import('./pages/dashboard/profile/set-password/set-password').then(m => m.SetPasswordComponent)
//       }
//     ]
//   },
//   {
